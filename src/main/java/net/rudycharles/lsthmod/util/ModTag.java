...
public class ModTag {
    public static class Items {
        ...
        private static TagKey<Item> Tag(String name) {
            return ItemTags.create(ResourceLocation.fromNamespaceAndPath(LittleSomethingMod.MODID, name));
        }
    }
    ...
    public static class Blocks {
        ...
        private static TagKey<Block> Tag(String name) {
            return BlockTags.create(ResourceLocation.fromNamespaceAndPath(LittleSomethingMod.MODID, name));
        }
    }
    ...
    public static class Enchantments {
        ...
        private static TagKey<Enchantment> Tag(String name) {
            return TagKey.create(Registries.ENCHANTMENT, ResourceLocation.fromNamespaceAndPath(LittleSomethingMod.MODID, name));
        }
    }
    ...
    public static class EntityTypes {
        ...
        private static TagKey<EntityType<?>> Tag(String name) {
            return TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(LittleSomethingMod.MODID, name));
        }
    }
}
